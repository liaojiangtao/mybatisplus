package com.gentel.mybatisplus.generate;
...
public class SuperGenerator {
    ...
    protected PackageConfig getPackageConfig() {
        return new PackageConfig()
                .setParent("com.gentel.mybatisplus")
    ...
    protected StrategyConfig getStrategyConfig(String tableName) {
        ...
        return new StrategyConfig()
                ...
                .setTablePrefix("tb_")// 去除前缀
                .setNaming(NamingStrategy.underline_to_camel)// 表名生成策略
                //.setInclude(new String[] { "user" }) // 需要生成的表
                //自定义实体父类
                .setSuperEntityClass("com.gentel.mybatisplus.framework.model.BaseModel")
                // 自定义实体，公共字段
                .setSuperEntityColumns("id")
                .setTableFillList(tableFillList)
                // 自定义 mapper 父类
                .setSuperMapperClass("com.gentel.mybatisplus.framework.mapper.BaseMapper")
                // 自定义 controller 父类
                .setSuperControllerClass("com.gentel.mybatisplus.framework.controller.SuperController")
                // 自定义 service 实现类父类
                .setSuperServiceImplClass("com.gentel.mybatisplus.framework.service.impl.BaseServiceImpl")
                // 自定义 service 接口父类
                .setSuperServiceClass("com.gentel.mybatisplus.framework.service.BaseService")
    ...
    protected DataSourceConfig getDataSourceConfig() {
        return new DataSourceConfig()
                ...
                .setUsername("root")
                .setPassword("123456")
                .setUrl("jdbc:mysql://47.98.111.83:3306//sell?useUnicode=true&characterEncoding=utf8");
    }
...
//        String resourcePath = getRootPath() + "/src/main/resources";
        String resourcePath = "E://Generator" + "/src/main/resources";
